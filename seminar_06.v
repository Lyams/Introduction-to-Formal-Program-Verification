...
Proof. elim: n f0 f1 => [|n IHn] f0 f1; first by rewrite muln0 muln1.
rewrite fib_iterS IHn /=.
Search _ addn muln.
by rewrite mulnDr mulnDl addnCA.
Qed.
...
Lemma nat_ind2' (P : nat -> Prop) :
  ...
  (forall n, P n -> P n.+2) ->
  forall n, P n.
Proof. move => p0 p1 Istep n.
suff: P n /\ P n.+1 by case.
by elim: n=> // n [/Istep]. Qed.
